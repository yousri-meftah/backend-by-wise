...
async function seedUser () {
  try {
    ...
    userToBeInserted = {
      'password':'9Af8sPJ7lgogQiQ',
      'isDeleted':false,
      'username':'Christian67',
      'email':'Bianka_McLaughlin11@hotmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.User
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let user = await dbService.updateOne(User, { 'username':'Christian67' }, userToBeInserted,  { upsert: true });
    userToBeInserted = {
      'password':'OBElfkBVjsC9uY0',
      'isDeleted':false,
      'username':'Eliezer.OConner',
      'email':'Kendall.Auer16@hotmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.Admin
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let admin = await dbService.updateOne(User, { 'username':'Eliezer.OConner' }, userToBeInserted,  { upsert: true });
