...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Delphia.Stroman88',
      password: 'wgzBJM_A1QhpsGA',
      email: 'Brenda_Leuschke@yahoo.com',
      name: 'Kenneth Kuhic',
      userType: 946,
      mobileNo: '(006) 908-7955',
      resetPasswordLink: {},
      loginRetryLimit: 60,
      loginReactiveTime: '2024-02-20T04:47:18.678Z',
      id: '655d0e65bc04e05b77e3ee11'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Griffin_Hoeger83',
        'password':'Mijq_8gUCRGxWcv',
        'email':'Helena94@gmail.com',
        'name':'Mr. Kelley Sanford',
        'userType':authConstant.USER_TYPES.User,
        'mobileNo':'(068) 475-8830',
